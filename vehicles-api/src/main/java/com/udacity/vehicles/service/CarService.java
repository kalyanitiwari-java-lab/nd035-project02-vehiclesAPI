        ...
        if (car.getId() != null) {
            return repository.findById(car.getId())
                    .map(carToBeUpdated -> {
                        ...
                        carToBeUpdated.setCondition(car.getCondition()); //review feedback changes : required
                        /*
                            commenting this code because, modifiedAt is set automatically  @LastModifiedDate in Car.java
                         */
                       // carToBeUpdated.setModifiedAt(car.getModifiedAt()); //review feedback changes : suggestion
